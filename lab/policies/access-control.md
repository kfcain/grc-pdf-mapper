...
**Review cycle:** Annual  
**Change control:** Pull request + GRC approval required  

**Framework alignment:** NIST SP 800-53 Rev. 5, ISO/IEC 27001:2022, SOC 2 TSC, NIST CSF 2.0, FedRAMP CR26 KSI (Classes A–D)
...
Privileged accounts must use multi-factor authentication. Temporary elevated access should expire within 24 hours.

Account reviews must occur at least quarterly. Orphaned accounts shall be disabled within 24 hours of detection.
...
Authentication events must be logged centrally. Security operations shall review privileged access anomalies weekly.
